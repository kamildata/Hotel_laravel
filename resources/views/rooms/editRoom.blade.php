    ...
    <form method="POST" action="{{ route('rooms.update',$room->id) }}">
     ...
     <div class="form-group mb-3">
        ...
        <div class="mb-3">
            ...
            <input value="{{$room->liczba_miejsc}}" id="liczba_miejsc" name="liczba_miejsc" type="number"
        ...
        <div class="mb-3">
            ...
            <input value="{{$room->cena}}" id="cena" name="cena" type="number"
                class="form-control @error('cena') is-invalid @enderror">
            <div class="invalid-feedback">Nieprawidłowe dane!</div>
        </div>
        <div class="mb-3">
            <label for="opis" class="form-label">Opis</label>
            <textarea class="form-control" id="opis" name="opis" aria-label="With textarea">{{$room->opis}}</textarea>
        </div>
